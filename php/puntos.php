...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
  if (!isset($_GET['id'])){
    ...
    $sql = $dbConn->prepare("SELECT * FROM usuario_puntos");
    $sql->execute();
    ...
    $sql = $dbConn->prepare("SELECT * FROM usuario_puntos WHERE id_usuario=:id ORDER BY id DESC LIMIT 1");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    $input = $_POST;
    $sql = "INSERT INTO usuario_puntos
          (id_usuario,historico_izquierda,historico_derecha)
          VALUES
          (:id_usuario,:historico_izquierda,:historico_derecha)";
